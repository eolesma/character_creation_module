...
def attack(char_name: str, char_class: str) -> str:
    """Функция, которая отвечает за расчет атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция, которая отвечает за расчет защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция, которая отвечает за расчет суперсилы."""
    if char_class == 'warrior':
        return (
...
def choice_char_class() -> str:
    """Функция отвечает за выбор класса."""
    approve_choice: str = ''
    char_class: str = ''
